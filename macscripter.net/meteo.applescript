...
on run
	...
	display notification (currentWeather & " (" & currentTemperature & temperatureScale & ")") Â
		with title ("Weather of the day")
	
	(*
	# You can also use a dialog
display dialog (currentWeather & " (" & currentTemperature & "¡C)") Â
		with title ("Weather of the day") Â
		with icon note Â
